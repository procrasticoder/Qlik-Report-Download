            ...
            controller: ['$scope', function ($scope) {
                ...
                async function getData(tableId) {
                    ...
                    async function myFunction(model, pageHeight, columns, pageNo) {
                        ...
                        model.getHyperCubeData('/qHyperCubeDef', [page]).then(val => {
                            console.log(val)
                            return val;
                        });
                    ...
                    async function myCaller(model, numberOfPages, pageHeight, columns, pageNo) {
                        ...
                        await myCaller(model, numberOfPages, pageHeight, columns, pageNo + 1);
                    };
                    ...
                    app.getObject(tableId).then(model => {
                        ...
                        let pageNo = 1;
                        myCaller(model, numberOfPages, pageHeight, tw, pageNo).then(val => {
                            console.log(val)
                        });
                        // console.log(result)
